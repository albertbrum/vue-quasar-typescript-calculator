            ...
            <q-card-section class="bg-primary">
              <div class="row justify-center items-center">
                ...
                <div class="col text-white">
                  <HistorySelector v-for="(results, index) in historyResults" :key="index">
                  ...
                  <!-- <q-expansion-item icon="history" label="Histórico" header-class="bg-indigo-8 text-white"
                    ...
                    <q-card class="bg-grey-2 text-indigo">
                      <q-scroll-area visible style="height: 100px; max-width: 300px;">
                        <q-card-section>
                          <div v-for="(result, index) in historyResults" :key="index">
...
const historyResults = ref(actionsInputKeys.historyResults)
